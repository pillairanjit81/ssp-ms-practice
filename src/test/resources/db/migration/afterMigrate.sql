...
insert into products (product_id, name, description, sku, price) values(1, 'Desk', 'Banana', 'SKU001', 1.19);
insert into products (product_id, name, description, sku, price) values(2, 'Chair', 'Bread', 'SKU002', 2.99);
insert into products (product_id, name, description, sku, price) values(3, 'Cabinet', 'Cereal', 'SKU003', 2.30);
